//Ще не фінальна версія, але всі основні правила гри працюють(Зробив рекурсію та вибір хто ходитиме першим, але так і не знайшов рішення проблеми з подвійною inp_num)//
#include <iostream>
#include <iomanip>
#include <conio.h>
using namespace std;
